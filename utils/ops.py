...
from contagem_de_veiculos.classes import matematica
import numpy as np
import six
...
def pad_to_multiple(tensor, multiple):
  ...
  if tensor_height is None:
    ...
    padded_tensor_height = int(
        matematica.ceil(float(tensor_height) / multiple) * multiple)
  ...
  if tensor_width is None:
    ...
    padded_tensor_width = int(
        matematica.ceil(float(tensor_width) / multiple) * multiple)
